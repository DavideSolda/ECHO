...
Note that src_lang[:exports code]{free_gripper} is a flunet, 
while src_lang[:exports code]{free_gripper()} is a literal. To negate a literal
add src_lang[:exports code]{-} before the predicate.
